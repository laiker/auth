...
func (c *userV1Client) FindByLogin(ctx context.Context, in *FindByLoginRequest, opts ...grpc.CallOption) (*FindByLoginResponse, error) {
	out := new(FindByLoginResponse)
	err := c.cc.Invoke(ctx, "/user_v1.UserV1/FindByLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserV1Server) FindByLogin(context.Context, *FindByLoginRequest) (*FindByLoginResponse, error) {
...
func _UserV1_FindByLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindByLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserV1Server).FindByLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_v1.UserV1/FindByLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).FindByLogin(ctx, req.(*FindByLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
